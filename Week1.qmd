...
First, I will use the Maximum Likelihood Estimation method to estimate $p$, which is the frequentist approach. Then, I will use a posterior mean, which is the Bayesian approach. Finally, I will compare them using my dataset.
...
For the Bayesian method, we need a prior distribution that we will then have the data update. Let's use a Beta$(\alpha, \beta)$ prior.
