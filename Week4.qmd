...
In the Normal distribution, $95\%$ of the mass is in the mean $\pm 1.96$ Standard deviations, which we will round to 2 for algebraic simplicity. As the Normal above has a standard deviation of 1, we can set up a 95% confidence interval that rounds to:
...
# roots of f(p) in the windows [0, p_hat] and [p_hat, 1]
