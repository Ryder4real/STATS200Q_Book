...
As we can see, at different true $p$ values, one estimator may be better than the other. This is an interesting result, and means that we cannot declare one officially estimator to be better than the other using frequentist MSE.
