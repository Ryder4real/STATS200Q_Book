...
Now, let's say we are trying out a new drug, and want to see if it is effective. So, maybe our alternative hypothesis is that $\theta_A = 5$. Hypothesis testing is seeing whether, based on the data, we can reject the null hypothesis and accept the alternative.
