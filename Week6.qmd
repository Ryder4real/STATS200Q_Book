...
As $600 > c$ (which was $448$), for my COVID hospital dataset, we reject $H_0$. This implies that we accept the alternative hypothesis that COVID is more contagious than the flu (though this dataset is not perfect as it only consists of people already in the hospital who infected at least $1$ person, so I do not want to extrapolate too much).
