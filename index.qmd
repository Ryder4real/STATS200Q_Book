...
It is important to note that the PDF I wrote out earlier includes $r$ in a choose function. Technically, this is not allowed, as $r$ is not necessarily an integer for my dataset. However, in practice, we can just use the gamma fraction to replace the choose function whenever computations are needed.
