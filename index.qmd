...
NOTE: There are chapters in the book with multiple R blocks. Some R blocks call on variables that were defined in a separate block earlier in that chapter. So, please make sure to run the R code in order for each chapter.
